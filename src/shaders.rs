...
fn prepare_shader(raw: &str) -> String {
    ...
    if !source.contains("u_palette_a") {
        out.push_str("uniform vec3 u_palette_a;\n");
        out.push_str("uniform vec3 u_palette_b;\n");
        out.push_str("uniform vec3 u_palette_c;\n");
        out.push_str("uniform vec3 u_palette_d;\n");

...
//
// Features:
//   - Bitmap font: 72 characters (katakana-style, digits, uppercase Latin,
//     symbols) encoded as 5×6 bit patterns in uint constants. The table is
//     generated by scripts/gen_terminal_glyphs.py — edit the ASCII art there.
...
// ---------------------------------------------------------------------------
// Bitmap font — 72 characters, each a 5×6 grid stored as a uint (30 bits).
...
// BEGIN GLYPH TABLE — generated by scripts/gen_terminal_glyphs.py, do not hand-edit
const int GLYPH_COUNT = 72;

uint glyphs[72] = uint[72](
    ...
    uint(0x0c846106u),  // 28: }
    uint(0x00220080u),  // 29: ;
    uint(0x231fc62eu),  // 30: A
    uint(0x1f18be2fu),  // 31: B
    uint(0x3c10843eu),  // 32: C
    uint(0x1f18c62fu),  // 33: D
    uint(0x3e10bc3fu),  // 34: E
    uint(0x0210bc3fu),  // 35: F
    uint(0x3d18e43eu),  // 36: G
    uint(0x2318fe31u),  // 37: H
    uint(0x3e42109fu),  // 38: I
    uint(0x1d184210u),  // 39: J
    uint(0x23149d31u),  // 40: K
    uint(0x3e108421u),  // 41: L
    uint(0x2318d771u),  // 42: M
    uint(0x231cd671u),  // 43: N
    uint(0x1d18c62eu),  // 44: O
    uint(0x0210be2fu),  // 45: P
    uint(0x2c9ac62eu),  // 46: Q
    uint(0x2292be2fu),  // 47: R
    uint(0x1f08383eu),  // 48: S
    uint(0x0842109fu),  // 49: T
    uint(0x1d18c631u),  // 50: U
    uint(0x08a8c631u),  // 51: V
    uint(0x23bac631u),  // 52: W
    uint(0x22a21151u),  // 53: X
    uint(0x08421151u),  // 54: Y
    uint(0x3e22221fu),  // 55: Z
    uint(0x1c21084eu),  // 56: [
    uint(0x1c84210eu),  // 57: ]
    uint(0x10421088u),  // 58: (
    uint(0x04421082u),  // 59: )
